  ...
  return (
    ...
    >
      <div className="relative w-full flex flex-col h-full">
          ...
          >
            {items.map((item, index) => (
              <motion.div
                ...
                key={"card" + index}
                className="w-[90%] md:w-[60%] lg:w-[45%] rounded-3xl"
              >
                {item}
              </motion.div>
            ))}
        ...
        <div className="flex justify-end gap-2 mr-10 mt-auto">
          <button
            className="relative z-40 h-10 w-10 rounded-full dark:bg-gray-100 bg-Primary flex items-center justify-center disabled:opacity-50"
            onClick={scrollLeft}
            disabled={!canScrollLeft}
          >
            <IconArrowNarrowLeft className="h-6 w-6 text-white dark:text-Primary" />
          </button>
          <button
            className="relative z-40 h-10 w-10 rounded-full dark:bg-gray-100 bg-Primary flex items-center justify-center disabled:opacity-50"
            onClick={scrollRight}
          ...
          >
            <IconArrowNarrowRight className="h-6 w-6 text-white dark:text-Primary" />
          </button>
        </div>
      </div>
    </CarouselContext.Provider>
